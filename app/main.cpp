...
int main() {
    ...
    sf::RenderWindow window(sf::VideoMode(windowSize), "FastMeasure");
    ...
    while (window.isOpen()) {
        ...
        sf::Color sfmlColor(circleColor.x * 255, circleColor.y * 255, circleColor.z * 255, circleColor.w * 255);
        shape.setFillColor(sfmlColor);

        static ImVec2 viewportSize{500, 500};
        sf::RenderTexture rt{};
        sf::Vector2i viewportsize(viewportSize.x, viewportSize.y);
